...
namespace setgame::ui {
    ...
    void SDLRenderer::finishSetRemoval(
        core::Game &game) {
    ...
    SDL_Rect SDLRenderer::getCardRect(
        int index) const {
